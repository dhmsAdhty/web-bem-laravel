<section id="event" class="py-16 bg-gradient-to-b from-blue-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12" data-aos="fade-down">
            <h2 class="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 mb-4">Event Terbaru</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
                <!-- Gradient overlay -->
                <div class="absolute inset-0 bg-gradient-to-t from-blue-900/70 to-blue-500/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
                ...
                <!-- Event content -->
                <div class="absolute bottom-0 left-0 right-0 p-6 text-white opacity-100 group-hover:opacity-0 transition-opacity duration-300 z-20">
                ...
                <!-- Hover content -->
                <div class="absolute inset-0 flex flex-col justify-end p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20">
                    ...
                    <div class="flex space-x-3">
                        <a 
                            ...
                            class="flex-1 text-center bg-white/90 text-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-white transition-all duration-300 transform hover:scale-105"
                        >
                            Detail
                        </a>
                        <a 
                            href="{{ route('event.register', $event->id) }}" 
