<section id="home" class="relative py-45 flex flex-col items-center text-center overflow-hidden">
    <!-- Background image -->
    ...
    <div class="relative z-10 flex flex-col items-center text-center mt-[-40px] animate-fadein">
        ...
        <h1 class="text-3xl md:text-5xl font-extrabold mb-2 animate-fadein-text"><span id="typing-bemft"></span></h1>
        <h2 class="text-xl md:text-2xl font-bold mb-4 animate-fadein-text"><span id="typing-kabinet"></span></h2>
    </div>
    <style>
        @keyframes fadein {
            0% {
    ...
    <script>
        ...
        typeText('typing-bemft', 'BEM FT UNWAHAS', 60, function() {
            setTimeout(function() {
                typeText('typing-kabinet', 'Kabinet CAKRA AKSATA', 60);
            }, 300);
        });
    });
    </script>
